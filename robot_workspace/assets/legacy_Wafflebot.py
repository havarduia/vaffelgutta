...
from robot_workspace.backend_controllers import legacy_find_pose_from_matrix, robot_boot_manager
...
class Wafflebot:
    ...
    def go_to(self, target):
        ...
        goal_pose = legacy_find_pose_from_matrix.find_pose_from_matrix(
            targetpose_matrix= target,
              currentpose_matrix= self.arm.get_ee_pose())
...
bot.arm.set_ee_cartesian_trajectory(x = -0.1, pitch=0.3)
pose = bot.arm.get_ee_pose_command()
bot.arm.go_to_home_pose()
