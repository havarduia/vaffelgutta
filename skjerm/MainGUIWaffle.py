...
waffle_button = tk.Button(
    root, text="Waffle Maker", command=lambda: open_script('C:\\Users\\Aleksander\\Desktop\\batchelor\\skjerm\\Waffle_maker.py'), 
...
cam_button = tk.Button(
    root, text="Cam", command=lambda: open_script('C:\\Users\\Aleksander\\Desktop\\batchelor\\skjerm\\Cam.py'), 
...
debug_button = tk.Button(
    root, text="Debug", command=lambda: open_script('C:\\Users\\Aleksander\\Desktop\\batchelor\\skjerm\\Debug.py'), 
...
games_button = tk.Button(
    root, text="Games", command=lambda: open_script('C:\\Users\\Aleksander\\Desktop\\batchelor\\skjerm\\Games_tab.py'), 
