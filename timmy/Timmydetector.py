...
# Remove the outdated import:
# from mediapipe.calculators import image as mp_Image

# Import the protobuf format for landmarks.
from mediapipe.framework.formats import landmark_pb2

class Timmydetectorclass:
    ...
    def start(self):
        ...
        while True:
            ...
            # Create MediaPipe Image using the top-level API.
            mp_image = mp.Image(
            ...
            if result.pose_landmarks:
                for person_landmarks in result.pose_landmarks:
                    # Convert landmarks to the required protobuf format
                    ...
                    # Draw the landmarks on the color image
                    ...
                    # Process each landmark to extract depth information
...
def Timmydetector():
    ...
    detector = Timmydetectorclass(config_loader, model_path)
    detector.start()
