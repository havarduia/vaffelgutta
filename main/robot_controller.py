...
class RobotController:
    ...
    def process_state(self):
        ...
        try:
            ...
            self.status_queue.put(f"Error in state {current_state.name}: {str(e)}")
    ...
    def _execute_state_action(self, current_state: State):
        ...
        match current_state:
            ...
            case State.SLEEP:
                ...
                sleepstate(self.state, self.bot)
    ...
    def run(self):
        ...
        try:
            ...
            self.status_queue.put(f"Critical error: {str(e)}")
            handle_error(e)
